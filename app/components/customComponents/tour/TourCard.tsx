...
const TourCard = ({
  ...
  return (
    <div className="flex flex-col w-full gap-5 rounded-md shadow-md p-5 max-h-[550px]">
      <div className="group flex items-center justify-center overflow-hidden rounded-3xl transition-all duration-150  relative">
        <Image
          src={imageSrc}
          alt={title}
          width={1000}
          height={1000}
          className="w-full h-auto rounded-3xl cursor-pointer group-hover:scale-105"
        />
        ...
        <div className="absolute bottom-0 left-0 w-full p-3 px-5 flex items-center justify-between backdrop-blur-sm">
          ...
          <div className="flex flex-col gap-1">
          <IoHeart color='#FF0000' size={25} className='cursor-pointer hover:scale-110' />
      ...
      <div className="flex flex-col w-full gap-5 ">
        ...
        <div className="flex items-center justify-between font-light text-[#949494] md:text-sm text-xs">
            <span className='flex items-center gap-2'><IoCalendarOutline /> {duration}</span>
            <span className=' text-[#4D4D4D] flex items-center gap-1'><IoMdShareAlt size={20} /> {numOfShare} share </span>
